...
<link href="<?php echo $this->webroot; ?>css/jquery-ui-1.11.2.custom.css" rel="stylesheet">
...
<script src="<?php echo $this->webroot; ?>js/jquery-ui-1.11.2.custom.min.js"></script>
