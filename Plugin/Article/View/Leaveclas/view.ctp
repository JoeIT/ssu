	...
	<div class="row-fluid show-grid">
		<div class="span12">
			<form class="form-horizontal">
					...
					<div class="controls">
						<?php echo $leaveclas['Leavecla']['LEAVENAME']; ?>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"><?php echo __('Simbolo: '); ?>
					</label>
					<div class="controls">
						<?php echo $leaveclas['Leavecla']['REPORTSYMBOL']; ?>
					</div>
				</div>
                            
				<div class="form-actions">
					<?php echo $this->Acl->link(__('Editar'), array('action' => 'edit', $leaveclas['Leavecla']['LEAVEID']),array('class'=>'btn  btn-primary')); ?>
