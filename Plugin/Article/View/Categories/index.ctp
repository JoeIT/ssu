...
<div class="container">
		...
		<div class="span12">
			<ul class="nav nav-tabs">
				...
				<?php }?>
					...
					<li><?php echo $this->Html->link(__('Usuarios'), array('plugin' => 'article','controller' => 'userinfos','action' => 'index')); ?></li>
				<?php }?>
	...
	'format' => __('Página {:page} de {:pages}, showing {:current} records out of {:count} total, starting on record {:start}, ending on {:end}')
	));
	?>
			</p>
			...
			<div class="pagination">
				<ul>
					...
					echo $this->Paginator->numbers(array('separator' => '','tag'=>'li'));
					echo $this->Paginator->next(__('Siguinte') . ' &rarr;', array('tag' => 'li','escape' => false));
					?>
				</ul>
			</div>
		</div>
