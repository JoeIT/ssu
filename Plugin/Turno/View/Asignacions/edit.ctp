		...
		<div class="span12">
			...
			<div class="control-group">
				...
				<label class="control-label"><?php echo __('Fecha de Nacimiento:'); ?><span
					style="color: red;">*</span> </label>
				<div class="controls">
					<?php echo $this->Form->input('BIRTHDAY',array('div' => false,'label'=>false,'dateFormat' => 'DMY','minYear' => date('Y')-60,'maxYear' => date('Y')-15,'timeFormat' => null,'error'=>false,'class'=>'input-small')); ?>
				</div>
			</div>
                        <div class="control-group">
