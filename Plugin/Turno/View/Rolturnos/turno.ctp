...
<div class="container">
	<h2>
		<?php echo __('Horarios Fijos: (Inicio)'); ?>
	</h2>
	...
	<?php echo $this->Form->create('Rolturno', array('action' => 'turno/'.$type,'class'=>' form-signin form-horizontal')); ?>
	<div class="row-fluid show-grid">
		<div class="span12">
		...
		<div class="span12">
			...
			<table class="table table-bordered table-hover list table-condensed table-striped">
				...
				<tr>
                                    ...
                                    ?>&nbsp;</td>
                                    <?php if ($this->Acl->check('Rolturnos','view','Turno') == true || $this->Acl->check('Rolturnos','general','Turno') == true){?>
                                    <td style="text-align: center;">
                                           <?php echo $this->Acl->link(__('Ver'), array('action' => 'view', $rturnos['Userinfo']['USERID']),array('class'=>'btn btn-mini')); ?>
                                           <?php echo $this->Acl->link(__('+ General'), array('action' => 'general', $rturnos['Userinfo']['USERID']),array('class'=>'btn btn-mini btn-primary')); ?>
                                           <?php echo $this->Acl->link(__('+ Ind'), array('action' => 'individual', $rturnos['Userinfo']['USERID']),array('class'=>'btn btn-mini btn-danger')); ?>
                                    </td>
                                    <?php } ?>
				</tr>
				<?php endforeach; ?>
...
function cancelSearch(tipo){
	...
	window.location = '<?php echo Router::url(array('plugin' => 'turno','controller' => 'rolturnos','action' => 'turno')); ?>/'+tipo;
}
