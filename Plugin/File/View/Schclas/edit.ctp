...
<div class="container">
	...
	<div class="row-fluid show-grid">
		<div class="span12">
			...
			<?php echo $this->Form->input('SCHCLASSID'); ?>
                        <div class="control-group">
				<label class="control-label"><?php echo __('Detalle:'); ?><span
					style="color: red;">*</span> </label>
				<div class="controls">
					<?php echo $this->Form->input('SCHNAME',array('div' => false,'label'=>false,'error'=>false,'class'=>'input-large')); ?>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label"><?php echo __('Hora Ingreso:'); ?><span
					style="color: red;">*</span> </label>
				<div class="controls">
					<?php echo $this->Form->input('STARTTIME',array('id'=>'STARTTIME','type'=>'text','maxlength'=>'19','div' => false,'label'=>false,'dateFormat' => 'DMY','timeFormat' =>24,'error'=>false,'class'=>'input-medium')); ?>
				</div>
			</div>
                        <div class="control-group">
				<label class="control-label"><?php echo __('Hora Salida:'); ?><span
					style="color: red;">*</span> </label>
				<div class="controls">
					<?php echo $this->Form->input('ENDTIME',array('id'=>'ENDTIME','type'=>'text','maxlength'=>'19','div' => false,'label'=>false,'dateFormat' => 'DMY','timeFormat' =>24,'error'=>false,'class'=>'input-medium')); ?>
				</div>
			</div>
                        <div class="control-group">
