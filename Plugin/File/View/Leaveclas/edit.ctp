...
<div class="container">
	...
	<div class="row-fluid show-grid">
		<div class="span12">
			...
			<?php echo $this->Form->input('LEAVEID'); ?>
                        <div class="control-group">
				<label class="control-label"><?php echo __('Detalle:'); ?><span
					style="color: red;">*</span> </label>
				<div class="controls">
					<?php echo $this->Form->input('LEAVENAME',array('div' => false,'label'=>false,'error'=>false,'class'=>'input-large')); ?>
				</div>
			</div>
			<div class="control-group">
				...
				<label class="control-label"><?php echo __('Tipo de Accion:'); ?><span
					style="color: red;">*</span> </label>
				<div class="controls">
					<?php $options=array('0.0'=>'No','1.0'=>'Trabaja');
