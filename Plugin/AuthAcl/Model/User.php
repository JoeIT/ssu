...
class User extends AuthAclAppModel {
	...
	public $validate = array(
            'user_email' => array(
                'required' => array(
                    'rule' => array('notEmpty'),
                    'message' => 'Por favor introduzca el valor de Correo electrónico.'
                ),
                'email' => array(
                    'rule' => array('email'),
                    'message' => 'Por favor Ingrese su dirección de correo electrónico válida'
                ),
            ...
            'user_password' => array(
                'required' => array(
                    'rule' => array('notEmpty'),
                    'message' => 'Por favor introduzca el valor de contraseña.'
                )
            ),
