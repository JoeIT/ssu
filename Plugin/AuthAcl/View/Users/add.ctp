	...
	<div class="row-fluid show-grid">
		<div class="span12">
			...
			<div
				...
				<label for="inputEmail" class="control-label"><?php echo __('Correo'); ?><span
			...
			<div
				...
				<label for="inputEmail" class="control-label"><?php echo __('Contraseña'); ?><span
					style="color: red;">*</span>
				</label>
				<div class="controls">
			...
			<div
				...
				<label for="inputEmail" class="control-label"><?php echo __('Confirmar Contraseña'); ?><span
					style="color: red;">*</span>
				</label>
				<div class="controls">
