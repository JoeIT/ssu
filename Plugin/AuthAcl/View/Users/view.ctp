		...
		<div class="span12">
			<form class="form-horizontal">
				<div class="control-group">
					<label for="inputEmail" class="control-label"><?php echo __('Correo'); ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label for="inputEmail" class="control-label"><?php echo __('Contraseña'); ?>
					</label>
					<div class="controls">******</div>
				</div>

				<div class="control-group">
					<label for="inputEmail" class="control-label"><?php echo __('Nombre'); ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label for="inputEmail" class="control-label"><?php echo __('Grupos'); ?>
					</label>
					<div class="controls">
						<?php
						$groupNames = array();
				...
				<div class="control-group">
					<label for="inputEmail" class="control-label"><?php echo __('Estado'); ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label for="inputEmail" class="control-label"><?php echo __('Creado'); ?>
					</label>
					<div class="controls">
				...
				<div class="control-group">
					<label for="inputEmail" class="control-label"><?php echo __('Modificado'); ?>
					</label>
					<div class="controls">
				...
				<div class="form-actions">
					<?php echo $this->Acl->link(__('Editar'), array('action' => 'edit', $user['User']['id']),array('class'=>'btn  btn-primary')); ?>
					<a class="btn " onclick="cancel_add_user();"><?php echo __('Cancelar'); ?>
					</a>
				</div>
			</form>
		</div>
