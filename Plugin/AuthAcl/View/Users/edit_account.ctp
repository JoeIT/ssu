<div class="container">
	<h2>
		<?php echo __('Mis Perfiles'); ?>
	</h2>
	<div class="row-fluid show-grid" id="tab_user_manager">
		<div class="span12">
			<ul class="nav nav-tabs">
				<li class="active"><a href="#"><?php echo __('Editar Cuenta'); ?></a></li>
			</ul>
		</div>
	</div>
	<div class="row-fluid show-grid">
		<div class="span12">
			...
			<div
				...
				<label for="inputEmail" class="control-label"><?php echo __('Confirmar Contraseña'); ?>
				</label>
				<div class="controls">
			...
			<div
				...
				<label for="inputEmail" class="control-label"><?php echo __('Nombre'); ?><span
			...
			<div class="form-actions">
				<input type="button" class="btn btn-info"
					value="<?php echo __('Guardar'); ?>" onclick="editAccount();" />
			</div>
		...
		$.post('<?php echo Router::url(array('plugin' => 'auth_acl','controller' => 'users','action' => 'editAccount')); ?>',$('#UserEditAccountForm').serialize(),function(o){
			if (o.error == 0){
				var strAlertSuccess = '<div class="alert alert-success" style="position: fixed; right:0px; top:45px; display: none;">'
					+ '<button data-dismiss="alert" class="close" type="button">×</button>'
					+ '<strong><?php echo __('Exito!'); ?></strong> <?php echo __('Ha editado con éxito su cuenta'); ?>'
					+ '</div>';
